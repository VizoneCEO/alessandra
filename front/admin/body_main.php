...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
    ...
    <a href="dashboard.php?page=usuarios&filter=alumnos"
        class="bg-white p-6 rounded-xl border border-zinc-100 shadow-sm hover:shadow-lg transition-all duration-300 relative overflow-hidden group block">
        ...
        <p class="text-[10px] text-zinc-400 font-light">Clic para gestionar</p>
    </a>

    <!-- KPI 2: Ingresos del Periodo -->
    <div
        class="bg-white p-6 rounded-xl border border-zinc-100 shadow-sm hover:shadow-lg transition-all duration-300 relative overflow-hidden group">
        <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
...
<!-- Accesos Rápidos con Diseño Editorial -->
<div class="grid grid-cols-1 md:grid-cols-2 gap-8">

    <a href="dashboard.php?page=usuarios"
        ...
        <div class="ml-6">
            <h4 class="font-serif text-xl text-zinc-900 group-hover:text-white mb-1 transition-colors">Gestión de
                Usuarios</h4>
            <p class="text-xs text-zinc-500 group-hover:text-zinc-400 font-light">Administrar profesores, alumnos y
                staff.</p>
        </div>
    ...
    <a href="dashboard.php?page=materias"
        ...
        <div class="ml-6">
            <h4 class="font-serif text-xl text-zinc-900 group-hover:text-white mb-1 transition-colors">Catálogo
                Académico</h4>
            <p class="text-xs text-zinc-500 group-hover:text-zinc-400 font-light">Configurar materias, asignaciones y
                grupos.</p>
        </div>
        <div class="ml-auto opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-2">
            <i class="fas fa-arrow-right text-white"></i>
