...
<div class="bg-white rounded-xl shadow-sm border border-zinc-100 p-6 mb-8">
    ...
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <!-- Accounts List (NO DELETE buttons here) -->
                        ...
                        <div
                            ...
                            <div class="mt-3 pt-3 border-t border-zinc-200">
                                <p class="text-[10px] text-zinc-500 uppercase tracking-wide">
                                    ...
                                    <strong>
                                        <?php echo $acc['total_students']; ?>
                                    </strong> Alumnos asignados
                                </p>
                            </div>
                        </div>
                    <?php endforeach; ?>
    ...
    <div class="p-6 border-b border-zinc-100 flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="text-zinc-600 font-medium flex items-center">
            ...
            <span id="totalActiveUsers"
                class="ml-2 bg-zinc-100 text-zinc-600 text-xs font-bold px-2 py-1 rounded-full border border-zinc-200">
                ...
                <?php while ($row = $result_users->fetch_assoc()): ?>
                    <tr class="hover:bg-zinc-50 transition-colors">
                        ...
                        <td class="px-6 py-4 font-mono text-xs text-zinc-500">
                            <?php echo htmlspecialchars($row['curp']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <span
                            ...
                            <?php if ($row['banco']): ?>
                                <div class="text-xs">
                                    <p class="font-bold text-zinc-700">
                                        <?php echo htmlspecialchars($row['banco']); ?>
                                    </p>
                                    <p class="text-[10px] text-zinc-500">
                                        <?php echo htmlspecialchars($row['titular']); ?>
                                    </p>
                                </div>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <!-- TOGGLE STATUS AND DELETE BUTTONS REMOVED FOR AYUDANTE -->
                            </div>
                        </td>
                    </tr>
                <?php endwhile; ?>
