    ...
    <form action="../../back/admin_actions_sucursales.php" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
            ...
            <div class="md:col-span-4">
                <button type="submit"
                    class="w-full py-2 bg-zinc-900 text-white text-xs font-bold uppercase tracking-widest hover:bg-zinc-800 transition-colors rounded">Crear
                    Sucursal</button>
            </div>
        </div>
    </form>
...
<div class="bg-white rounded-xl shadow-sm border border-zinc-100 overflow-hidden">
    <div class="p-6 border-b border-zinc-100">
        <div class="text-zinc-600 font-medium flex items-center"><i class="fas fa-building mr-2 text-zinc-400"></i>
                ...
                <?php while ($row = $result_sucursales->fetch_assoc()): ?>
                    <tr class="hover:bg-zinc-50 transition-colors">
                        <td class="px-6 py-4 font-medium text-zinc-900">
                            <?php echo htmlspecialchars($row['nombre_sucursal']); ?>
                        </td>
                        <td class="px-6 py-4">
        ...
        <form action="../../back/admin_actions_sucursales.php" method="POST">
            <div class="px-6 py-4 border-b border-zinc-100 flex justify-between items-center bg-zinc-50">
                ...
                <button type="button" onclick="closeEditModal()"
                    class="text-zinc-400 hover:text-rose-500 transition-colors"><i class="fas fa-times"></i></button>
            </div>
            <div class="p-6">
