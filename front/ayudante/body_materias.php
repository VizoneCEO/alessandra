<?php
// front/ayudante/body_materias.php
// --- 1. OBTENER DATOS ESENCIALES ---
require '../../back/db_connect.php';

// a) Obtener TODOS los ciclos escolares
...
// b) Obtener TODAS las sucursales
...
// c) Determinar el ciclo seleccionado
...
// d) Determinar la sucursal seleccionada
...
// g) Obtener las clases asignadas
$clases_asignadas = [];
...
<?php if (isset($_SESSION['message'])): ?>
    <div class="p-4 mb-6 text-sm rounded-lg border bg-zinc-50 text-zinc-800 border-zinc-200 flex justify-between items-center"
        role="alert">
        <span>
            ...
            <form action="../../back/admin_actions_materias.php" method="POST" class="flex flex-col space-y-3">
                ...
                <div class="flex space-x-2">
                    <input type="text"
                        ...
                        name="nombre_materia" placeholder="Nombre" required>
                ...
                <button type="submit"
                    class="w-full py-2 bg-zinc-900 text-white text-[10px] font-bold uppercase tracking-widest hover:bg-zinc-800 transition-colors rounded">Añadir</button>
            </form>
        </div>
    </div>
</div>
...
<div class="mb-6 border-b border-zinc-100 pb-2">
    ...
    <span class="ml-2 font-serif italic text-emerald-600 font-bold">
        <?php echo htmlspecialchars($selected_ciclo_nombre); ?>
    </span>
    <span class="mx-2 text-zinc-300">/</span>
    <span class="font-serif italic text-indigo-600 font-bold">
        <?php echo htmlspecialchars($selected_sucursal_nombre); ?>
    </span>
</div>
...
<?php if (!$selected_ciclo_id || !$selected_sucursal_id): ?>
    <div class="p-8 border border-dashed border-zinc-300 rounded-xl text-center">
        ...
        <p class="text-zinc-500 text-sm">Por favor, selecciona un Ciclo y una Sucursal.</p>
    </div>
<?php else: ?>
        ...
        <div class="mb-10" id="semestre_<?php echo $i; ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div class="px-5 py-4 flex-1 space-y-3 bg-zinc-50/20">
                                <?php if (isset($clases_asignadas[$materia['id']])): ?>
                                    <?php foreach ($clases_asignadas[$materia['id']] as $clase): ?>
                                        <?php $total_alumnos = $conteo_alumnos[$clase['id']] ?? 0; ?>
                                        <div
                                            ...
                                            <div class="flex items-center min-w-0 flex-1 mr-2">
                                                ...
                                                <div class="min-w-0">
                                                    ...
                                                    <div class="flex items-center space-x-2 mt-0.5">
                                                        ...
                                                        <span
                                                            class="text-[10px] font-bold bg-zinc-100 text-zinc-600 px-2 py-0.5 rounded border border-zinc-200 uppercase tracking-wide">Grp:
                                            ...
                                            <div class="flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
                                                <a href="dashboard.php?page=asignacion&clase_id=<?php echo $clase['id']; ?>"
                                                    ...
                                                    title="Asignar Alumnos"><i class="fas fa-user-plus"></i></a>
                                                ...
                                                <!-- DELETE CLASS REMOVED FOR AYUDANTE -->
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                                    ...
                                    <div class="flex flex-col xl:flex-row gap-2">
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <button type="submit"
                                                ...
                                                title="Asignar"><i class="fas fa-plus"></i></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <?php if (!$materias_en_semestre): ?>
                    <div class="col-span-full py-8 text-center text-zinc-400 text-xs italic bg-zinc-50/50 rounded-lg">No hay
                        materias registradas.</div>
                <?php endif; ?>
            </div>
        </div>
    <?php endfor; ?>
