...
// 2. Comprobar si el usuario es Finanzas (perfil_id = 5)
...
<head>
    ...
    <title>Panel Financiero | AF Luxury</title>
    <!-- Tailwind CSS -->
...
<body class="bg-white h-screen flex overflow-hidden">
    ...
    <aside class="w-64 bg-zinc-950 text-white flex-shrink-0 flex flex-col border-r border-zinc-900 shadow-2xl z-20">
        ...
        <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto">
            ...
            <p class="text-[10px] uppercase tracking-[0.2em] text-zinc-600 font-bold mb-4 px-4">Finanzas</p>
        ...
        <div class="p-6 border-t border-zinc-900 bg-zinc-950">
            <div class="flex items-center mb-4">
                ...
                <div class="overflow-hidden">
                    ...
                    <p class="text-[10px] text-zinc-500 uppercase tracking-widest">Finanzas</p>
                </div>
            </div>
    ...
    <main class="flex-1 flex flex-col relative overflow-hidden bg-white">
        ...
        <div class="flex-1 overflow-y-auto p-8 md:p-12 relative">
            <?php
            $allowed_pages = ['main', 'finanzas'];
            if (in_array($page, $allowed_pages)) {
                if ($page == 'main') {
                    include 'body_main.php';
                } elseif ($page == 'finanzas') {
                    include '../admin/body_finanzas.php';
                }
            } else {
                include 'body_main.php';
            }
